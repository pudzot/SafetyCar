...
final public class Router: NSObject, RouterType, UINavigationControllerDelegate, UIAdaptivePresentationControllerDelegate {
    ...
    public func setNavigationBarHidden(isHidden: Bool = false) {
